...
class JsonUtils {
    private static JSONObject getJsonObject(String URL, String input) throws JSONException, ExecutionException, InterruptedException {
        com.example.myapp.MyAsyncTask asyncTask = new com.example.myapp.MyAsyncTask();
    ...
    static com.example.myapp.Word getWordInfoFromJson(String URL, String input) throws JSONException {
        JSONObject obj = null;
        try {
        ...
        com.example.myapp.Word word = new com.example.myapp.Word();
        try {
